        ...
        <div>
            ...
            <div className="max-w-screen-2xl mx-auto md:px-10 px-6">
                ...
                <div className="w-[80%] mx-auto">
                    <SectionTitles heading={'Looking for Reliable Commercial Cleaning Leads?'} subHeading={"Janitorial Appointment connects cleaning companies with top commercial centers, hospitals, schools, and offices. Register now for exclusive access to appointment-setting opportunities."} />
                </div>
                <div>
                    <Offers />
                </div>
